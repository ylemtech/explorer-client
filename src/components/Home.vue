    ...
    <el-main>
          ...
          <el-row class="container-inner">
            ...
            <el-col class="block">
              <div class="container">
                ...
                <div class="value">{{thousands(block.total_difficulty)}}</div>
              </div>
            </el-col>
          </el-row>
        </el-col>
      ...
      <el-row class="blocks">
        <el-row class="head">
          ...
          <el-col class="buttons"><el-button type="primary" round @click="getBlockItems()">&nbsp;&nbsp;Refresh&nbsp;&nbsp;</el-button><el-button type="primary" round @click="getBlockItems()">View Blocks</el-button></el-col>
        </el-row>
        <el-row class="block">
          <el-col v-for="item in block.blocks" :key="item.num" class="container">
            <div class="content">
              <a class="number" href="/block/16417709">#{{item.num}}</a>
              <div class="panel"> 
                <div class="desc">
                  <span class="title">{{item.trans}} Transactions</span>
                  <span class="time">{{item.time_offset}} ago</span>
                </div>
                <div class="desc">
      ...
      <el-row class="transactions">
        <el-col class="inner">
          <el-row class="head">
            ...
            <el-col class="button"><el-button type="primary" round @click="getBlockItems()">View Transactions</el-button></el-col>
          </el-row>
          <el-row class="transaction">
            <el-col  style="padding-bottom: 15px;">
              <el-row class="body">
                <el-col class="type">Transaction</el-col>
                <el-col class="content">
                  <div class="hash">
                    <a href="#">0x409a0bce5104cd29fdc6f0b2a2ee1c96439eccb0e2392e1a32fc043c8185b61d</a>
                  </div>
                  <div class="operation">
                    <a href="#">0x77Ea8Fd97D80326830Ee4C25C8E1E51438127f26</a> → <a href="#">0x77Ea8Fd97D80326830Ee4C25C8E1E51438127f26</a>
                  </div>
                  <div class="fee">0.00209016 BST</div>
                </el-col>
                <el-col class="block">
                  <div class="num"><a href="#" >Block #16423494</a></div>
                  <div class="time">3 seconds ago</div>
                </el-col>
              </el-row>
            </el-col>
          </el-row>
          ...
          <el-row class="transaction">
            <el-col  style="padding-bottom: 15px;">
              <el-row class="body contract">
                <el-col class="type contract">Contract Call</el-col>
                <el-col class="content">
                  <div class="hash">
                    <a href="#">0x409a0bce5104cd29fdc6f0b2a2ee1c96439eccb0e2392e1a32fc043c8185b61d</a>
                  </div>
                  <div class="operation">
                    <a href="#">0x77Ea8Fd97D80326830Ee4C25C8E1E51438127f26</a> → <a href="#">0x77Ea8Fd97D80326830Ee4C25C8E1E51438127f26</a></div>
                  <div class="fee">0.00209016 BST</div>
                </el-col>
                <el-col class="block">
                  <div class="num"><a href="#" >Block #16423494</a></div>
  ...
  methods:{
    async getBlock(){
        ...
        for(let i=0;i<res.blocks.length;i++){ 
          let span = now - res.blocks[i].timestamp
          ...
          this.block.blocks[i].time_offset = t
        }
    },
    thousands(num){
